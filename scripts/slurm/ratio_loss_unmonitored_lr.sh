...
#SBATCH --job-name=rlunlr
#SBATCH --output=logs/slurm/rlunlr_%A_%a.out
#SBATCH --error=logs/slurm/rlunlr_%A_%a.err
...
flags="--silent --clean --logdir=benchmarks/ratio_loss_monitored_lr --unmonitor --no_csv --lr 0.001"
