...
#SBATCH --output=logs/slurm/tresunlr_%A_%a.out
#SBATCH --error=logs/slurm/tresunlr_%A_%a.err
...
flags="--silent --clean --logdir=benchmarks/tresnet_unmonitored_lr --no_csv --lr 0.001 --unmonitor"
