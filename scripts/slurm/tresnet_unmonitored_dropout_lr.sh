...
#SBATCH --job-name=tresunlr
#SBATCH --output=logs/slurm/tresdunlr_%A_%a.out
#SBATCH --error=logs/slurm/tresdunlr_%A_%a.err
...
flags="--silent --clean --logdir=benchmarks/tresnet_unmonitored_dropout_lr --no_csv --lr --dropout 0.02 0.001 --unmonitor"
