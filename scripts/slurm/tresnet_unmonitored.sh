...
#SBATCH --job-name=tresun
#SBATCH --output=logs/slurm/tresun_%A_%a.out
#SBATCH --error=logs/slurm/tresun_%A_%a.err
...
flags="--silent --clean --logdir=benchmarks/tresnet_unmonitored --no_csv --unmonitor"
