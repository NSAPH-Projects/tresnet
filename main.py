...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="dataset/simu1/eval/0",
        help="dir of eval dataset",
    )
    parser.add_argument(
        "--save_dir", type=str, default="logs/simu1/eval", help="dir to save result"
    )

    # training
    parser.add_argument(
        "--n_epochs", type=int, default=800, help="num of epochs to train"
    )

    # print train info
    parser.add_argument(
        "--verbose", type=int, default=100, help="print train info freq"
    )
    ...
    for model_name in method_list:
        ...
        if (
            model_name == "Vcnet_tr"
            or model_name == "Drnet_tr"
            or model_name == "Tarnet_tr"
        ):
            isTargetReg = 1
        else:
            isTargetReg = 0
